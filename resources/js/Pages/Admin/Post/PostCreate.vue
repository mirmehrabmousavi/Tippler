                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <transition name="slide-fade">
                            <div class="allCreatePostDetailItems">
                                ...
                                <div class="allCreatePostDetailItem">
                                    <label>کشور :</label>
                                    <post-taxonami :taxes="countries" :taxRoute="'کشور'" :tax="['0']"  v-on:sendTax="getCountry"></post-taxonami>
                                </div>
                                <div class="allCreatePostDetailItem">
...
export default {
    name: "PostCreate",
    props : ['categories','countries','brands','guarantees','allow','userData','times','errors'],
    ...
    methods:{
        ...
        getCountries(country){
            this.form.allCountries = country;
        },
        getColor(Color){
