                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <transition name="slide-fade">
                            <div class="allCreatePostDetailItems">
                                ...
                                <div class="allCreatePostDetailItem">
                                    <label>برچسب :</label>
                                    <post-taxonami :taxes="tags" :taxRoute="'برچسب'" :tax="['0']"  v-on:sendTax="getTag"></post-taxonami>
                                </div>
                            </div>
                        </transition>
                    </div>
    ...
    methods:{
        sendData(){
            ...
            this.$inertia.post(url , this.form)
                .then(response=>{
                    if (!this.errors.name && !this.errors.title && !this.errors.image && !this.errors.summery && !this.errors.type && !this.errors.status){
