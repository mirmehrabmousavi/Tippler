        ...
        <div class="allHeaderIndexRegisterItemsContainer" v-if="level == 5">
            <div class="allHeaderIndexRegisterItem">
                ...
                <label for="nameUser" class="allHeaderIndexInput">
                    <input v-model="name" title="نام کاربری خود را وارد کنید ..." placeholder="نام کاربری خود را وارد کنید ..." ref="item" id="nameUser" type="text"/>
                </label>
            </div>
            ...
            <div class="allHeaderIndexRegisterItem">
                ...
                <label for="passwordUser" class="allHeaderIndexInput">
                    <input v-model="password" placeholder="رمز عبور خود را وارد کنید" id="passwordUser" type="password"/>
                </label>
            </div>
