<template>
    <div class="allImageSlider width">
        <div class="image" v-if="data.moreEn">
            <a :href="'/products/widget/' + JSON.parse(data.moreEn)[0].address">
                <img :src="JSON.parse(data.moreEn)[0].image" :alt="JSON.parse(data.moreEn)[0].image">
            </a>
        </div>
