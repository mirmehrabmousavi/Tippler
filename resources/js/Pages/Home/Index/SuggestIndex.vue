<template>
    <section class="allSuggest">
        <div class="blocks" :style="'background-image: url(/img/backSuggest.png)'">
            <div class="block width">
                <div class="top">
                    ...
                    <div class="left">
                        <div class="remaining">
                            <i>
                                <svg-icon :icon="'#patternTime'"></svg-icon>
                            </i>
                            <span>زمان باقی مانده</span>
                        </div>
                        <flip-countdown :deadline="data.background"></flip-countdown>
                    </div>
                </div>
                <div class="bot">
