...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" class="form-control @error('description') is-invalid @enderror ckeditor" name="description" placeholder="محتوا"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <button id="createFaqs" class="btn btn-outline-success btn-sm mr-1 mb-1 waves-effect waves-light">ذخیره</button>
        </div>
    </div>
@endsection
