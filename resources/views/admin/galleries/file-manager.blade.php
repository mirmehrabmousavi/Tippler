<div class="col-12">
    ...
    <button type="button" class="btn btn-sm btn-outline-white waves-effect waves-light mb-1" data-toggle="modal" data-target="#gallery">تصاویر خود را وارد کنید</button>
    <!-- Modal -->
                        ...
                        $(`<div class="col-lg-2 col-md-3 col-sm-6">
                            ...
                            .click(function () {
                                ...
                                $('#imageContainer').append(
                                    $(`<div id="getImagePic" class="col-lg-4 col-md-6 col-sm-12">
                                    <a>
                                        <div class="card overlay-img-card text-white dataGallery">
                                            <img src="${imageUrl}" class="card-img" alt="card-img-6" height="200">
                                            <div class="card-img-overlay overlay-black">
        ...
        dropzone.on("complete", function(file) {
            ...
            $.ajax({
                ...
                success: (response) => {
                    ...
                    $('#imageTooltip').hide();
                    $('#imageContainer').append(
                        $(`<div id="getImagePic" class="col-lg-4 col-md-6 col-sm-12 parent">
                                <a>
                                    <div class="card overlay-img-card text-white dataGallery">
                                        <img src="${image_url}" class="card-img" alt="card-img-6" height="200">
                                        <div class="card-img-overlay overlay-black">
