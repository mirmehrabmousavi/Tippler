                    ...
                    <div class="card-content">
                        <div class="table-responsive mt-1">
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tr id="dataRow-{{$brand->id}}">
                                    <td>
                                        <fieldset>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input sub_chk" name="checkbox[]" data-id="{{$brand->id}}" id="check-{{$brand->id}}">
                                                <label class="custom-control-label" for="check-{{$brand->id}}"></label>
                                            </div>
                                        </fieldset>
                                    </td>
                                    <script>
                                        $('#check-{{$brand->id}}').on('change', function() {
                                            var isChecked = $(this).prop('checked');
                                            var $tr = $('#dataRow-{{$brand->id}}');
                                    ...
                                    <td>{{$brand->name}}</td>
                                    <td>
                                        <ul class="list-unstyled users-list" style="height: 30px; width: 30px;">
                                            <li class="avatar pull-up m-0">
                                                <img class="media-object rounded-circle" src="@if($brand->image != '[]'){{asset(json_decode($brand->image)[0]->image)}}@endif" alt="Avatar" height="30" width="30">
                                            </li>
                                        </ul>
                                    </td>
                                    <td>{{jdate($brand->created_at)->ago()}}</td>
                                    <td>
                                        <a class="text-secondary mr-1 waves-effect waves-light" data-toggle="modal" data-target="#show-{{$brand->id}}"><i class="feather icon-eye"></i></a>
                                        <div class="modal fade text-left" id="show-{{$brand->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true" style="display: none;">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row d-flex justify-content-center">
                                                            <ul class="list-unstyled users-list" style="height: 60px; width: 60px;">
                                                                <li class="avatar pull-up m-0">
                                                                    <img class="media-object rounded-circle" src="@if($brand->image != '[]'){{asset(json_decode($brand->image)[0]->image)}}@endif" alt="Avatar" height="60" width="60">
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <div class="col-12 mt-1">
                                                                ...
                                                                <p class="text-center text-white">{{$brand->slug}}</p>
                                                            </div>

                                                            <div class="col-12 mt-1">
                                                                <p class="text-center">توضیحات</p>
                                                                <span class="text-center text-white">{!! $brand->description !!}</span>
                                                            </div>

                                                            <div class="col-12 mt-1">
                                                                <p class="text-center">عنوان سئو</p>
                                                                <p class="text-center text-white">{{$brand->meta_title}}</p>
                                                            </div>

                                                            <div class="col-12 mt-1">
                                                                <p class="text-center">کلمات کلیدی سئو</p>
                                                                <p class="text-center text-white">{{$brand->meta_keyword}}</p>
                                                            </div>

                                                            <div class="col-12 mt-1">
                                                                <p class="text-center">توضیحات سئو</p>
                                                                <p class="text-center text-white">{{$brand->meta_desc}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <a class="text-secondary mr-1 waves-effect waves-light" data-toggle="modal" data-target="#edit-{{$brand->id}}"><i class="feather icon-edit"></i></a>
                                        <div class="modal fade text-left" id="edit-{{$brand->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true" style="display: none;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="name1" value="{{$brand->name}}" class="form-control @error('name') is-invalid @enderror" placeholder="نام را وراد کنید" name="name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="main_slug1">پیوند :</label>
                                                                            <input type="text" id="main_slug1" value="{{$brand->slug}}" class="form-control @error('slug') is-invalid @enderror" placeholder="پیوند را وارد کنید" name="slug">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="main_description1">توضیحات* :</label>
                                                                            <textarea id="main_description1" name="description" class="form-control ckeditor">{!! $brand->description !!}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="meta_title1">عنوان متا :</label>
                                                                            <input type="text" id="meta_title1" value="{{$brand->meta_title}}" class="form-control @error('meta_title') is-invalid @enderror" name="meta_title" placeholder="عنوان متا را وارد کنید">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="meta_keyword1">کلمه کلیدی متا :</label>
                                                                            <textarea id="meta_keyword1" class="form-control @error('meta_keyword') is-invalid @enderror" name="meta_keyword" placeholder="با , جدا کنید">{!! $brand->meta_keyword !!}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="meta_desc1">توضیحات متا :</label>
                                                                            <textarea id="meta_desc1" class="form-control @error('meta_desc') is-invalid @enderror" name="meta_desc" placeholder="توضیحات متا را وارد کنید">{!! $brand->meta_desc !!}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                        ...
                                        <a class="text-secondary mr-1 waves-effect waves-light text-danger" data-toggle="modal" data-target="#delete-{{$brand->id}}"><i class="feather icon-trash"></i></a>
                                        <div class="modal fade text-left" id="delete-{{$brand->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                            ...
                            {{$brands->links('admin.pagination.paginate')}}
                            @else
                                <div class="alert alert-danger text-center"><i class="fa fa-info-circle"></i> برندی وجود ندارد</div>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            $('.delete_all').on('click', function(e) {
                ...
                if(allVals.length <=0)
                {
                    ...
                    if(check === true){
                        ...
                        $.ajax({
                            url: '{{route('admin.brands.destroyAll')}}',
                            type: 'DELETE',
